...
var loadPosition = function(dept_code, curr_apply_user, b_m){
	...
	else if(encodeURI(dept_code).substring(0,7)=="1020402"){
		ajax.addParameter("parameters", "dept_code3=" + encodeURI("1020402")+"&dept_code2="+encodeURI(dept_code));
	}
	...
	else if(encodeURI(dept_code).substring(0,5)=="10604"){
		
		ajax.addParameter("parameters", "dept_code3=" + encodeURI("10604")+"&dept_code2="+encodeURI(dept_code));
	}
	else if(encodeURI(dept_code).substring(0,5)=="10605"){
		ajax.addParameter("parameters", "dept_code3=" + encodeURI("10605")+"&dept_code2="+encodeURI(dept_code));
	}
	...
	}else if(encodeURI(dept_code).substring(0,7)=="1031402"){
		ajax.addParameter("parameters", "dept_code3=" + encodeURI("1031402")+"&dept_code2="+encodeURI(dept_code));
	}
