		...
		<div class="tab_warp main">
			<div class="dq_step">${path}
				<span class="opb lb op-area">
						<a href="<s:url action="transverse_list" namespace="/qkjmanager"></s:url>">返回列表</a>
				</span>
			</div>
			
			<s:form id="serachForm" name="serachForm" action="transverse_checklist" method="get" namespace="/qkjmanager" theme="simple">
				<div class="label_con">
