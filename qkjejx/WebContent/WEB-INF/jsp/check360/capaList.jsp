...
<div class="tab_right">
 	<div class="tab_warp main" >
		<div class="dq_step">
			${path}
				<span class="opb lb op-area"><a href="<s:url namespace="/check360" action="check_loadCapa360"><s:param name="viewFlag">add</s:param></s:url>">提交</a></span>
		</div>
		<s:form id="serachForm" name="serachForm" action="check_listCapa360" method="get" namespace="/check360" theme="simple">
			<div class="label_con">
				<div class="label_main">
					<div class='label_hang'>
						<div class='label_ltit'>主键:</div>
						<div class='label_rwben'>
							<s:textfield name='capa.uuid' cssClass=' validate[maxSize[10],custom[integer],]' />
						</div>
					</div>
					<div class="label_hang">
						<div class="label_ltit">所属人:</div>
						<div class="label_rwben">
							<input id="begintime" name="capa.user_name" type="text"/>
						</div>
					</div>
