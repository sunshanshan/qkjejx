...
<a href="<s:url namespace="/check360" action="check_loadDetailExcel"><s:param name="score.user_id" value="score.user_id"></s:param><s:param name="score.check_ym" value="score.check_ym"></s:param><s:param name="jaspername">ass_report_index.jasper</s:param></s:url>">导出Excel</a>
</span>
</div>

<s:form id="serachForm" name="serachForm" action="check_loadIndexDetail" method="get" namespace="/check360" theme="simple">
			<div class="label_con">
			...
			<div class="effect">
	            <div class="slideTxtBox">
	                <div class="hd">
	                    <ul>
	                        <li><a  href="<s:url namespace="/check360" action="check_loadDetail"><s:param name="score.user_id" value="score.user_id"></s:param><s:param name="score.check_ym" value="score.check_ym"></s:param></s:url>">项目分析报告</a></li>
	                        <li class="on"><a>因素分析报告</a></li>
	                    </ul>
	                </div>
	            </div>
	        </div>
...
<%
		...
		//调用报表模版
		JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(path+"/WEB-INF/jsp/check360/jasper/ass_report_index.jasper");
