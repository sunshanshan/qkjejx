...
<a href="<s:url namespace="/check360" action="check_loadDetailExcel"><s:param name="score.user_id" value="score.user_id"></s:param><s:param name="score.check_ym" value="score.check_ym"></s:param><s:param name="jaspername">ass_report.jasper</s:param></s:url>">导出Excel</a>

</span>
</div>

<s:form id="serachForm" name="serachForm" action="check_loadDetail" method="post" namespace="/check360" theme="simple">
			<div class="label_con">
		...
		<div class="label_hang">
			...
			<div class="effect">
	            <div class="slideTxtBox">
	                <div class="hd">
	                    <ul>
	                        <li class="on"><a>项目分析报告</a></li>
	                        <li><a href="<s:url namespace="/check360" action="check_loadIndexDetail"><s:param name="score.user_id" value="score.user_id"></s:param><s:param name="score.check_ym" value="score.check_ym"></s:param></s:url>">因素分析报告</a></li>
	                    </ul>
	                </div>
	            </div>
	        </div>
